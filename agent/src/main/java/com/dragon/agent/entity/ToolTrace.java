...
/**
 * 工具调用追溯（ToolTrace）——记录 MCP / Function Calling 的工具调用历史。
 * 当前为预留设计，后续接入 MCP 时启用。
 *
 * @author 陈龙
 * @since 2026-06-01
 */
...
public class ToolTrace {
    ...
    public ToolTrace(String id, String messageId, String conversationId,
                     String toolName, String arguments, String status) {
        this.id = id;
