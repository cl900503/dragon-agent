 ...
 */
@Entity
@Table(name = "retrieval_traces", indexes = {@Index(name = "idx_rt_message", columnList = "message_id"),
...
public class RetrievalTrace {
    ...
    public RetrievalTrace(String id, String messageId, String conversationId, String documentName, Integer chunkIndex,
            Double score, String contentSnippet) {
        this.id = id;
