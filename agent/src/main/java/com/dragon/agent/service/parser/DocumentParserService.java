 ...
 *
 * 支持 PDF、Word、Excel、PPT、TXT、Markdown 等 1000+ 文件格式。 解析结果返回为 Spring AI Document
 * 对象，附带文件名和 MIME 类型元数据。
 *
 * @author 陈龙
 * @since 2026-06-01
 */
...
public class DocumentParserService {
    ...
    public Document parse(InputStream inputStream, String fileName, String mimeType) {
        try {
            ...
            return new Document(content, Map.of("source", fileName, "mimeType", mimeType != null ? mimeType : "unknown",
